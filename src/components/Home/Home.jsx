...
const Home = () => {
  ...
  const fetchCoins = async () => {
    ...
    try {
      const response = await axios.post("https://backend-mini-game.onrender.com/api/user/findCoins", {
        username: userData.username,
      });
  ...
  const collectFarming = async () => {
    ...
    try {
      const response = await axios.post("https://backend-mini-game.onrender.com/api/user/saveCoins", {
        username: userData.username,
        coins: 14400,
      });
